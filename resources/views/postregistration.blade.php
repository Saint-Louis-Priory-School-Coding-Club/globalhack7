    ...
    <p class="card-text">
      <form id="UserInfo" action="#" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputCountry1 CoB" placeholder="Country of Birth" required>
        </div>

        <div class="form-group">
          <label for="exampleInputLanguage1">Primary Language:</label>
          <input type="text" class="form-control" id="exampleInputLanguage1 PriLang" placeholder="Primary Language" required>
        </div>
